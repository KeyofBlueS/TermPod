...
pod_entry_pod4_t* pod_file_pod4_add_entry(pod_file_pod4_t* pod_file, pod_entry_pod4_t* entry, pod_string_t filename, pod_byte_t* data)
{
...
pod_entry_pod4_t* pod_file_pod4_del_entry(pod_file_pod4_t* pod_file, pod_number_t entry_index)
{
	if (pod_file == NULL)
	{
