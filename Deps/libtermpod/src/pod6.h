...
pod_file_pod6_t* pod_file_pod6_add_entry(pod_file_pod6_t* pod_file, pod_entry_pod6_t* entry, pod_string_t filename, pod_byte_t* data);
pod_file_pod6_t* pod_file_pod6_del_entry(pod_file_pod6_t* pod_file, pod_number_t entry_index);
