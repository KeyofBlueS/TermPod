...
pod_entry_pod1_t* pod_file_pod1_add_entry(pod_file_pod1_t* pod_file, pod_entry_pod1_t* entry, pod_string_t filename, pod_byte_t* data)
{
...
pod_entry_pod1_t* pod_file_pod1_del_entry(pod_file_pod1_t* pod_file, pod_number_t entry_index)
{
	if (pod_file == NULL)
	{
